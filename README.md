# Router-Suggest: Dynamic Routing for Multimodal Auto-Completion in Visually-Grounded Dialogs [EACL 2026]
...
```bash
   zip -s 0 MMDD-mp-split.zip --out MMDD.zip
   zip -s 0 ImageChat-mp-split.zip --out ImageChat.zip
```
